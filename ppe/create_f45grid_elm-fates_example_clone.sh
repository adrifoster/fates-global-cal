...
export TAG='clone_1'              # User defined tag to differentiate runs
...
# point to the build directory of a previously compiled case
...
cat >> user_nl_elm <<EOF
fates_paramfile='/qfs/people/need138/RCmodes/Parameter_files/fates_params_spmode_1.nc'
use_fates_sp = .true.
